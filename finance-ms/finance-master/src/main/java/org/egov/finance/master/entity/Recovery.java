...
@Data
public class Recovery extends AuditDetailswithVersion {
	...
	// @OptionalPattern(regex = Constants.ALPHANUMERIC, message = "Special
	// Characters are not allowed in IFSC Code")
	private String ifscCode;

	@Length(max = 32)
	@SafeHtml
	// @Pattern(regex = FinancialConstants.numericwithoutspecialchar, message =
