...
import org.egov.finance.voucher.model.HODDepartment;
...
public class Assignment {
	...
	// result = prime * result + ((functionary == null) ? 0 :
	// functionary.hashCode());
	// result = prime * result + ((fund == null) ? 0 : fund.hashCode());
	// result = prime * result + ((govtOrderNumber == null) ? 0 :
	// govtOrderNumber.hashCode());
	// result = prime * result + ((grade == null) ? 0 : grade.hashCode());
	// result = prime * result + ((hod == null) ? 0 : hod.hashCode());
	// result = prime * result + ((id == null) ? 0 : id.hashCode());
	// result = prime * result + ((isPrimary == null) ? 0 : isPrimary.hashCode());
	// result = prime * result + ((lastModifiedBy == null) ? 0 :
	// lastModifiedBy.hashCode());
	// result = prime * result + ((lastModifiedDate == null) ? 0 :
